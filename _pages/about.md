...
redirect_from: 
  ...
  - /about.html
---
I am Szu-Yu (Eva) Mo (莫絲羽) from Taiwan. Currently I am joining [Athleo.ai](https://athleo.ai/) — an AI-powered sports video storytelling platform — as CTO / Founding Engineer, and developing the TransFOMO app as my pet project on the side. I'm also open to any interesting robotics/computer-vision related job openings — please feel free to reach out! Previously, I worked full-time as a computer vision engineer in the autonomous driving department of NVIDIA. Before that, I was pursuing my Master's Degree in the program - Master of Robotics and Systems Development ([MRSD](https://mrsd.ri.cmu.edu/)) under the School of Computer Science - at Carnegie Mellon University (class of 2021). Please feel free to contact me. 
